...
def plot_avg_tangential_velocity_vs_radius(avg_tangential_velocities, tangential_velocity_errors):
    ...
    plt.xlabel('Radio (r)')
    plt.ylabel('Velocidad tangencial promediada (vθ)')
...
def plot_avg_radial_velocity_vs_radius(avg_radial_velocities, radial_velocity_errors):
    ...
    plt.figure()
    plt.errorbar(radii, avg_vr, yerr=errors, fmt='o', linestyle="none", capsize=5, capthick=1, elinewidth=1, color='r')
    plt.xlabel('Radio (r)')
    plt.ylabel('Velocidad radial promediada (vr)')
